...
func main() {
	...
	// Under the hood, we can think of interface as a concrete value pair that holds the dynamic type
	s = ball // variable of interface can hold any type that implements the interface
	...
	// In Go, variable have type known at the compilation and never changes
	// But the interfaces has the dynamic type that can change at runtime
